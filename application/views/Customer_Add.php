<div id="content" class="content">
	...
	<div class="col-12">
		...
		<div class="panel-body">
		    <form action="<?php echo site_url('IcomCtr/Customer_Add'); ?>" method="post" id="form_validation" name="form_validation" enctype="multipart/form-data">
			<div class="row">
			    <div class="form-group col-md-3">
				<label class="control-label">Customer Code</label>
				<input type="text" class="form-control input-sm" name="CUST_CODE" placeholder="Customer Code">
			    </div>
			    <div class="form-group col-md-3">
				<label class="control-label">Customer Name</label>
				<input type="text" class="form-control input-sm" name="CUST_NAME" placeholder="Customer name">
			    </div>
			    <div class="form-group col-md-3">
				...
				<input type="text" class="form-control input-sm" name="CUST_EMAIL" placeholder="Customer Email">
			    </div>
			</div>
			<div class="row">
			    <div class="form-group col-md-3">
				<label class="control-label">Address 1</label>
				<input type="text" class="form-control input-sm" name="CUST_ADDRESS1" placeholder="Customer Address">
			    </div>
			    <div class="form-group col-md-3">
				<label class="control-label">Address 2</label>
				<input type="text" class="form-control input-sm" name="CUST_ADDRESS2" placeholder="Customer Address">
			    </div>
			    <div class="form-group col-md-3">
				<label class=" control-label">Mobile No</label>
				<input type="text" class="form-control input-sm" name="CUST_MOBILE_NO" placeholder="Enter Moiler No" />
			    </div>
			    <div class="form-group col-md-3">
			...
			<div class="row">
				...
				<input type="text" class="form-control input-sm" name="CUST_EMP_LAST_VISIT" placeholder="Provide last visited detail" />
			    </div>
			    <div class="form-group col-md-3">
				<label class="control-label">Customer Feedback</label>
				<textarea class="form-control input-sm" name="CUST_FEEDBACK" placeholder="Enter Your Feedback here.." rows="1"></textarea>
			    </div>				
			</div>
...
<script>
	...
	({
		...
		CUST_CODE:{
			...
			remote: {
				message: 'Customer code is already existed',
				url: '<?php  echo site_url('IcomCtr/AjaxCustCode')?>',
				type: 'POST'
			},
			regexp: {
			    regexp: /^[A-Z0-9]+$/,
