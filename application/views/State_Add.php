	<div id="content" class="content">
	    ...
	    <!-- end breadcrumb -->
	    <!-- begin page-header -->
	    <h1 class="page-header">State<small> You may add State details here...</small></h1>
	    <!-- end page-header -->
	    <!-- begin row -->
	    <div class="row">
		<!-- begin col-10 -->
		<div class="col-md-12">
			...
			<div class="panel-body">
			    <form action="<?php echo base_url('IcomCtr/State_Add'); ?>" class="form-horizontal" id="form_validation" method="post" name="form_validation" enctype="multipart/form-data">                   
				<div class="well">
				<legend class="pullmenu">Add State Details</legend>
				<div class="row">
				    <div class="col-md-4">
					<div class="form-group">
					    <label class="col-md-4">State Code</label>
					    <div class="col-md-12">
						<input class="form-control input-sm" name="StateCode" value="" type="text" placeholder="State Code">
					    </div>
					</div>
				    </div>
				    <div class="col-md-4">
					<div class="form-group">
					    ...
					    <div class="col-md-12">
						<input class="form-control input-sm" name="StateDesc" value="" type="text" placeholder="State Description">
					    </div>
					</div>
				    </div>
                                    <div class="col-md-4">
