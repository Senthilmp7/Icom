...
<head>
	<meta charset="utf-8" />
	<title>Icom Admin | Login Page</title>
...
<body>
	...
	<div class="login-cover">
	    <div class="login-cover-image Clrchange"><img src="<?php echo site_url('application/assets/img/login-bg/icom1.jpg')?>" data-id="login-cover-image" alt="" /></div>
	...
	<div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated flipInX">
            ...
            <div class="login-header">
                <div class="brand">
                    <span><img class="img-responsive ImgAdj" src="<?php echo base_url('application/assets/img/ITC_logo1.png');?>"/></span>Admin Login
	    ...
	    <div class="row">
            ...
            <div class="login-content">
                <form action="<?php echo base_url('IcomCtr/index'); ?>" method="POST" class="margin-bottom-0">
                    ...
                    <div class="login-buttons">
                        <button type="submit" value="yes" name="proceed" class="btn btn-danger btn-block btn-lg">Sign me in</button>
                    </div>
                    <div class="m-t-20">
