...
<style>
	...
	margin-left:10px;
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
			    ...
			    <li><a href="<?php echo site_url('IcomCtr/serviceCall');?>">Inbound call</a></li>
			    <li class="active">service</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Inbound Call<small> You may view Inbound Call details here</small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
			    <!-- begin col-12 -->
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Inbound Call</h4>
                        </div>
                        <div class="panel-body" id="form_validation">
			    <p><a class="btn btn-primary btn-sm" href="<?php echo site_url('IcomCtr/Service_Edit/add');?>"><i class="fa fa-plus fa-1x"></i>
		        <span class="f-s-14 f-w-500">Add</span></a></p>
                            <div class="table-responsive">
				<!--<div class="buttonRow">
				<img src="<?php echo site_url('/application/uploads/tv.png');?>" onclick="product('TV');"class="product img-thumbnail">
				<img src="<?php echo site_url('/application/uploads/ac.png');?>" class="product img-thumbnail" onclick="product('Air Conditioner');">
	...
	<div class="modal-dialog modal-lg">
		...
		<form  id="category-form" class="smart-form" >
			...
			<b class="Colorchange">Inbound Service Call Details</b>
...
$(document).ready(function() {	  
    ...
    "bServerSide": true,
    "bProcessing": false,
    "sAjaxSource": '<?php echo site_url('IcomCtr/generateService'); ?>',
    'responsive': true,
    //'scrollX':true,
    "lengthMenu": [
	[10, 20, 50, -1],
	...
	{ data: "SH_ITEM_STATUS"},
	{
		...
		$phpvar="'+ data['SH_SYS_ID']+ '";  echo site_url('IcomCtr/Service_Edit/edit/'.$phpvar);?>" class="btn btn-xs" ><i class="fa  fa-edit"></i> Edit</a></li><li><a class="btn btn-xs"  id="delete_box" data-toggle="modal" href="<?php $phpvar="'+ data['SH_SYS_ID']+ '"; echo site_url('IcomCtr/Service_Delete/'.$phpvar);?>" <i class="fa fa-trash-o"></i> Delete </a></li></ul></div></td></td>'
	    }
	},
    ],
...
<script>
	...
	$.ajax({
	    type:"POST",
	    url:"<?php echo site_url('IcomCtr/MoreInfoView');?>",
	    data:{valu:valu},
	    //dataType:"json",
