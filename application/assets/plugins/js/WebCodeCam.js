...
(function($, window, document, undefined) {
	base_url= '<?= base_url() ?>';
		console.log(WebBarCode),
		
	'use strict';
	
	var Self, lastImageSrc, con, display, w, h,baseUrls,
		streams = {},
		camera = $('<video style="position:absolute;visibility:hidden;display: none;">')[0],
		flipped = false,
		isStreaming = false,
		baseUrls = WebBarCode+'assets/plugins/js/DecoderWorker.js',
		DecodeWorker = new Worker(baseUrls),
		delay = false,
