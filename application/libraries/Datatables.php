  ...
  // echo $sWhere; exit();
    ...
    */
	...
	$tableName = $this->table;
      ...
      if($aaData[$row_key]['SH_ITEM_STATUS']=="REQ"){
      $aaData[$row_key]['SH_ITEM_STATUS']='<button data-target="#large_view" id="created" class="btn btn-primary statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key]['SH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['SH_SYS_ID'].')>Requested</button>';
      }
      else if($aaData[$row_key]['SH_ITEM_STATUS']=="PROCESS"){
      $aaData[$row_key]['SH_ITEM_STATUS']='<button data-target="#large_view" id="created" class="btn btn-warning statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key]['SH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['SH_SYS_ID'].')>Process</button>';
	
      }
      else if($aaData[$row_key]['SH_ITEM_STATUS']=="COMPLETED"){
      $aaData[$row_key]['SH_ITEM_STATUS']='<button data-target="#large_view" id="created" class="btn btn-info statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key]['SH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['SH_SYS_ID'].')>Completed</button>';
      }
      else if($aaData[$row_key]['SH_ITEM_STATUS']=="DELIVERED"){
      $aaData[$row_key]['SH_ITEM_STATUS']='<button data-target="#large_view" id="created" class="btn btn-success statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key]['SH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['SH_SYS_ID'].')>Delivered</button>';
      }
      else if($aaData[$row_key]['SH_ITEM_STATUS']=="CANCEL"){
      $aaData[$row_key]['SH_ITEM_STATUS']='<button data-target="#large_view" id="created" class="btn btn-danger statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key]['SH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['SH_SYS_ID'].')>Cancelled</button>';
      }
    }
